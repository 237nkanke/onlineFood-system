                                ...
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                <div class="figure-wrap bg-image" data-image-src="'.$r['image'].'"></div>
                                                <div class="content">
                                                    <h5><a href="dishes.php?res_id='.$r['id'].'">'.$r['name'].'</a></h5>
                                                    <div class="product-name">'.$r['origin'].'</div>
                                                    <div class="price-btn-block"> <span class="price">$'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
            ...
            <div class="container">
                            ...
                            <nav class="primary pull-left">
                                <ul>
									...
									$res= mysqli_query($db,"select * from products");
										  ...
										  {
											echo '<li><a href="#" data-filter=".'.$row['image'].'"> '.$row['name'].'</a> </li>';
										  }
									?>
                ...
                <div class="row">
                    <div class="restaurant-listing">
						...
						<?php  
						$ress= mysqli_query($db,"select * from products");  
									      while($rows=mysqli_fetch_array($ress))
										  {
													
													$query= mysqli_query($db,"select * from products where id='".$rows['id']."' ");
														...
														<div class="restaurant-wrap">
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="dishes.php?res_id='.$rows['id'].'" >'.$rows['origin'].'</a></h5> <span>'.$rows['price'].'</span>
																</div>
